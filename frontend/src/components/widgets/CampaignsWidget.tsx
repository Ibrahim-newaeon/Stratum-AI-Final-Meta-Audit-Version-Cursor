...
const mockCampaigns = [
  { id: 1, name: 'Summer Sale 2024', platform: 'facebook', roas: 4.2, spend: 12450, trend: 'up' },
  ...
  { id: 4, name: 'Instagram Influencer', platform: 'instagram', roas: 3.0, spend: 7800, trend: 'down' },
];
