...
// Countries for Meta Ads Library
const COUNTRIES = [
...
export function AddCompetitorModal({ isOpen, onClose, onSuccess }: AddCompetitorModalProps) {
  ...
  const handleAddCompetitor = async () => {
    ...
    try {
      ...
      setNewCompetitor({ name: '', domain: '', country: 'SA', platforms: ['facebook', 'instagram'] });
      refetchCompetitors();
      onSuccess?.();
      onClose();
    } catch (error) {
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Track competitor ads via Meta Ads Library
            </p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Used to search ads in Meta Ads Library
            </p>
          </div>
