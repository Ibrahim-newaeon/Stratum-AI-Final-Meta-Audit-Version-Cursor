    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center">
        ...
        >
          ...
          <strong style={{ color: 'rgba(255, 255, 255, 0.7)' }}>$24K/month</strong> in wasted ad spend. Optimize
          Facebook, Instagram and WhatsApp campaigns with Trust-Gated Autopilot — every AI decision is auditable,
          explainable and reversible, with one-click human override.
        </p>
