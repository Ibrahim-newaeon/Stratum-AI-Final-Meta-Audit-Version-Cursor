...
const stats = [
  ...
  { value: '3', label: 'Meta Channels', sublabel: 'Synced' },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center">
          ...
          >
            ...
            . Predict ROAS, LTV, churn, conversion and creative fatigue across Facebook, Instagram and WhatsApp—automatically.
          </motion.p>
