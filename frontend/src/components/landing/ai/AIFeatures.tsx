...
const aiModels = [
  {
    ...
    description:
      'ML-powered predictions for Facebook, Instagram & WhatsApp campaigns with channel-specific baselines.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-gray-400">scikit-learn</span>
          </div>
        </motion.div>
      </div>
    </section>
