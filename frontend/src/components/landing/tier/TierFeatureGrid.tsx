        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 px-6 py-4 rounded-2xl bg-gray-900/50 border border-white/5">
            <div className="flex -space-x-2">
              {['bg-facebook', 'bg-instagram', 'bg-whatsapp'].map((bg, i) => (
                <div key={i} className={`w-8 h-8 rounded-full ${bg} border-2 border-gray-900`} />
              ))}
            </div>
            <div className="text-left">
              <div className="text-sm text-white font-medium">Full Meta coverage</div>
              <div className="text-xs text-gray-500">Facebook, Instagram &amp; WhatsApp</div>
            </div>
          </div>
        </div>
      </div>
