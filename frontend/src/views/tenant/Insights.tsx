...
const platformPerformance = [
  { platform: 'Facebook', spend: 14200, revenue: 52000, roas: 3.66, conversions: 780, cpa: 18.21, ctr: 3.2 },
  { platform: 'Instagram', spend: 12500, revenue: 45000, roas: 3.6, conversions: 620, cpa: 20.16, ctr: 1.8 },
  { platform: 'WhatsApp', spend: 5200, revenue: 18500, roas: 3.56, conversions: 312, cpa: 16.67, ctr: 2.4 },
];

const topCampaigns = [
  { name: 'Holiday Sale 2024', platform: 'Facebook', status: 'active', spend: 8500, revenue: 32000, roas: 3.76 },
  { name: 'Brand Reels Push', platform: 'Instagram', status: 'active', spend: 6200, revenue: 28000, roas: 4.52 },
  { name: 'Summer Retargeting', platform: 'Facebook', status: 'active', spend: 4800, revenue: 15500, roas: 3.23 },
  { name: 'Stories Awareness', platform: 'Instagram', status: 'paused', spend: 3200, revenue: 11000, roas: 3.44 },
  { name: 'WhatsApp Promo Q4', platform: 'WhatsApp', status: 'active', spend: 2100, revenue: 8200, roas: 3.9 },
];
