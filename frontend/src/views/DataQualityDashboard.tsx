                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-center py-2 font-medium">Facebook</th>
                      <th className="text-center py-2 font-medium">Instagram</th>
                  ...
                  <tbody className="divide-y">
                    {mockParameterCoverage.map((row) => (
                      <tr key={row.parameter} className="hover:bg-muted/30">
                        ...
                        {[row.facebook, row.instagram, row.whatsapp].map((value, idx) => (
