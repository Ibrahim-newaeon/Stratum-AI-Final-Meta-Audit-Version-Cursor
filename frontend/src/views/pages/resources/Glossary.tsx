    ...
    terms: [
      {
        ...
        definition:
          'Audience created on a Meta channel (Facebook, Instagram, WhatsApp) from CDP segment.',
      },
      {
        term: 'Sync Status',
    ...
    terms: [
      {
        ...
        values: [
          { value: 'FACEBOOK', description: 'Facebook Feed, Stories & Reels' },
          { value: 'INSTAGRAM', description: 'Instagram Feed, Stories & Reels' },
          { value: 'WHATSAPP', description: 'WhatsApp Business & Click-to-WhatsApp' },
        ],
      },
      {
      ...
      },
      {
        ...
        values: [
          { value: 'Facebook', description: '1-day view, 7-day click typical' },
          { value: 'Instagram', description: '1-day view, 7-day click typical' },
          { value: 'WhatsApp', description: '7-day click window' },
        ],
      },
      {
