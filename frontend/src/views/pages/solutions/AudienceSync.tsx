 ...
 * Meta audience synchronization (Facebook, Instagram, WhatsApp)
 */
...
const platforms = [
  { name: 'Facebook', description: 'Custom Audiences API' },
  { name: 'Instagram', description: 'Instagram Graph API' },
    ...
    <PageLayout>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Push your CDP segments to Facebook, Instagram, and WhatsApp with one click. Keep
