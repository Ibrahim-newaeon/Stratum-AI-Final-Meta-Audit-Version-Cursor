...
const features = [
  ...
  {
    icon: ArrowPathIcon,
    title: 'Meta Channel Sync',
    description:
      'Push segments to Facebook, Instagram & WhatsApp instantly. Auto-sync keeps your audiences fresh.',
    color: '#f97316',
  },
  {
    icon: SparklesIcon,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <table className="w-full">
              ...
              <tbody>
                {[
                  ['Meta channel sync (FB, IG, WA)', true, true, true],
