...
Will This Conflict with Other MCP Servers?
------------------------------------------
...
MCP_TOOLS = [
    {
        "name": "get_accounts",
        "description": "Get all advertising accounts across Meta channels (Facebook, Instagram, WhatsApp)",
        "inputSchema": {
            "type": "object",
            "properties": {
                "platform": {
...
class StratumMCPServer:
    ...
    async def initialize(self):
        ...
        from app.stratum.adapters import WhatsAppAdapter
    ...
    async def _handle_track_conversion(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "platforms_sent": args.get("platforms", ["meta"]),
            "status": "sent",
        }
...
"""
IMPORTANT: Stratum MCP Server and other MCP servers are COMPLEMENTARY

Other MCP servers typically provide:
- Team messaging (Slack)
- Local filesystem access
- Issue tracking, docs, etc.

Stratum MCP Server provides:
- Ad platform management (Meta: Facebook, Instagram, WhatsApp)
...
- "Save this report to the reports folder" -> Filesystem MCP
"""
