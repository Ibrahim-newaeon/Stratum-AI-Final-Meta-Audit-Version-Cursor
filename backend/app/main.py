...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description=(
            ...
            "We optimize Facebook, Instagram and WhatsApp campaigns with Trust-Gated Autopilot - "
            "every AI decision is auditable, explainable and reversible, with one-click human override. "
            "Built-in predictive models for ROAS, LTV, churn, conversion and creative fatigue. "
            "SOC 2 Type II, GDPR and CCPA compliant. Connect any ad account read-only. "
