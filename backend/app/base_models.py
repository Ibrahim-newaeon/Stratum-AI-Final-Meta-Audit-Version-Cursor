...
class AdPlatform(str, PyEnum):
    """Supported advertising platforms (Meta: Facebook, Instagram, WhatsApp)."""
...
class Campaign(Base, TimestampMixin, SoftDeleteMixin, TenantMixin):
    """
    Unified campaign model that normalizes data from Meta channels (Facebook, Instagram, WhatsApp).
...
class LandingPageSubscriber(Base):
    ...
    Includes full attribution tracking for Meta ad channels (Facebook, Instagram, WhatsApp)
