# =============================================================================
# Attribution Variance (Platform vs Analytics)
# =============================================================================
"""
Attribution Variance Calculator.
From AI_Logic_Formulas_Pseudocode.md Section 5.

Goal: Quantify divergence between platform-reported and web analytics data.
Helps explain "platform says X but analytics says Y".
...
def attribution_variance(
    ...
    """
    Calculate attribution variance between platform and web analytics.
    ...
    Args:
        ...
        ga4_revenue: Analytics-attributed revenue
        ga4_conversions: Analytics-attributed conversions
    ...
    if ga4_revenue > 0:
        ...
        rev_var = 0.0 if platform_revenue == 0 else 1.0  # 100% variance if analytics is 0
    ...
    if has_significant_variance:
        if rev_var_pct > variance_threshold_pct:
            warning_message = (
                f"Platform reports {rev_var_pct:.1f}% more revenue than web analytics. "
                "This may indicate attribution window differences or cross-device tracking gaps."
            )
        elif rev_var_pct < -variance_threshold_pct:
            warning_message = (
                f"Web analytics reports {abs(rev_var_pct):.1f}% more revenue than platform. "
