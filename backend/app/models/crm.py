...
class CRMDeal(Base):
    ...
    attributed_platform = Column(String(50), nullable=True)  # meta, organic
...
class Touchpoint(Base):
    ...
    # Platform/source
    source = Column(String(50), nullable=False)  # meta
...
class DailyPipelineMetrics(Base):
    ...
    platform = Column(String(50), nullable=True)  # meta (null = all)
