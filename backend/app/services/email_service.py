...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f8fafc; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
        ...
        <ul style="padding-left: 20px;">
            <li><strong>Connect your ad accounts</strong> - Link Facebook, Instagram and WhatsApp (read-only)</li>
...
- Connect your ad accounts (Facebook, Instagram, WhatsApp)
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f8fafc; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
        ...
        <p>Stratum AI is an AI-powered revenue operating system for ad teams. We optimize Facebook, Instagram and WhatsApp campaigns with Trust-Gated Autopilot — every AI decision is auditable, explainable and reversible, with one-click human override.</p>
...
Stratum AI is an AI-powered revenue operating system for ad teams. We optimize Facebook, Instagram and WhatsApp campaigns with Trust-Gated Autopilot.
