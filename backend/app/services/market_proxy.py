    ...
    async def get_competitor_data(self, domain: str) -> CompetitorData:
        ...
        try:
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                # NOTE: "engine" is a required SerpApi request parameter that selects
                # the upstream search engine backend; the value is an API identifier.
            ...
            detected_platforms = ["search"] if ads else []
    ...
    async def get_competitor_data(self, domain: str) -> CompetitorData:
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0, auth=auth) as client:
                # NOTE: the search-engine segment in these paths is a fixed part of the
                # DataForSEO Labs API route, not a product integration.
                # Domain overview
